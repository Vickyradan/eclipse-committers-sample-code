...
public class Science_10th_Standard {

	
	@FindBy(xpath="//*[@id='hid6']/h3/a")
	public static WebElement BookBack;
	
	@FindBy(xpath="//*[@id='tab-12']/div/div/div/div[5]/div[2]/a")
	public static WebElement science;  //*[@id="tab-12"]/div/div/div/div[5]/div[2]/a
