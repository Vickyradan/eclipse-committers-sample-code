...
public class SocialScience_7th_Standard {

	
	@FindBy(xpath="//*[@id='hid6']/h3/a")
	public static WebElement BookBack;
	
	@FindBy(xpath="//*[@id='tab-12']/div/div/div/div[2]/div[3]/a")
	public static WebElement socialscience;//*[@id="tab-12"]/div/div/div/div[2]/div[3]/a
